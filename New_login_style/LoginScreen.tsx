...
import { Fingerprint, Mail, Lock, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
                      ...
                      >
                        {passkeyScanning ? (
                          <div className="flex flex-col items-center justify-center py-4">
                            ...
                            <p className="font-body text-xs font-semibold text-text-primary flex items-center gap-1.5">
                              <span
                                ...
                                style={{ borderTopColor: '#e64833', width: '12px', height: '12px' }}
                              />
                          ...
                          <div className="text-center w-full">
                            ...
                            <button type="button" onClick={handlePasskeySubmit} className="login-btn">
