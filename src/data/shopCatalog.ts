...
export const SHOP_CATALOG: ShopCatalogItem[] = [
  ...
  {
    id: 'madrid-midnight',
    name: 'Madrid Midnight',
    description: 'Sleek executive dark mode inspired by Madrid nights with Midnight Blue and Warm Amber accents.',
    category: 'themes',
    type: 'theme',
    priceInCoins: 150,
    rarity: 'epic',
    ...
    effect: 'Midnight dark background (#121214), Midnight Blue accent (#1D4ED8), Warm Amber accent (#F59E0B)',
  },
  {
    id: 'aztec-gold',
    name: 'Aztec Gold',
    description: 'Regal executive dark theme with Deep Midnight Slate background, Emerald Gold and Emerald Green accents.',
    category: 'themes',
    type: 'theme',
    priceInCoins: 300,
    rarity: 'legendary',
    ...
    effect: 'Deep Midnight Slate background (#0F172A), Emerald Gold accent (#D97706), Emerald Green accent (#10B981)',
  },
  {
    id: 'theme_midnight',
