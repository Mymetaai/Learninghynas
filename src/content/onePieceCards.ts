export interface OnePieceCard {
  ...
  emoji: string;
  imageUrl: string; // Direct local character render URL
  bounty: string;
  description: string;
  specialMove: string;
...
export const ONE_PIECE_CARDS: OnePieceCard[] = [
  ...
  },
  {
    ...
    rarity: 'legendary',
    emoji: '⚔️🔴',
    imageUrl: '/assets/gacha/op18.png',
  ...
  // Epic
  {
    ...
    rarity: 'epic',
    emoji: '👒🍖',
    imageUrl: '/assets/gacha/op17.png',
  ...
  // Rare
  {
    ...
    rarity: 'rare',
    emoji: '🍊⚡',
    imageUrl: '/assets/gacha/op11.png',
  ...
  },
  {
    ...
    rarity: 'rare',
    emoji: '🦾🤖',
    imageUrl: '/assets/gacha/op10.png',
  ...
  },
  {
    ...
    rarity: 'rare',
    emoji: '🎻💀',
    imageUrl: '/assets/gacha/op15.png',
  ...
  // Common
  {
    ...
    rarity: 'common',
    emoji: '眼镜⚓',
    imageUrl: '/assets/gacha/op16.png',
    bounty: 'None (Marine)',
  ...
  },
  {
    ...
    rarity: 'common',
    emoji: '🎯👃',
    imageUrl: '/assets/gacha/op12.png',
  ...
  },
  {
    ...
    rarity: 'common',
    emoji: '🩺🦌',
    imageUrl: '/assets/gacha/op13.png',
    bounty: '1,000 Belly',
